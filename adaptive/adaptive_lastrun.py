...
expName = 'adaptive'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='/Users/shrutigupta/Desktop/lab in psychology/adaptive/adaptive_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    grating = visual.GratingStim(
        ...
        ori=1.0, pos=(0, 0), draggable=True, size=(0.3, 0.3), sf=8.0, phase=0.0,
    ...
    for thisStair in stair:
        ...
        while continueRoutine:
            ...
            if key_resp.status == NOT_STARTED and t >= 0.5-frameTolerance:
                # keep track of start time/frame for later
