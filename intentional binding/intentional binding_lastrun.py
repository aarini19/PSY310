...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='/Users/shrutigupta/Desktop/lab in psychology/intentional binding/intentional binding_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    polygon_2 = visual.ShapeStim(
        ...
        ori=0.0, pos=(0, 0), draggable=False, anchor='center',
        lineWidth=1.0,
        colorSpace='rgb', lineColor=[1.0000, 0.2549, -0.0431], fillColor=[1.0000, 0.2549, -0.0431],
    ...
    trials = data.TrialHandler2(
        ...
        extraInfo=expInfo, 
        originPath=-1, 
        trialList=data.importConditions('/Users/shrutigupta/Downloads/ib_cons.xlsx'), 
        seed=None, 
    )
